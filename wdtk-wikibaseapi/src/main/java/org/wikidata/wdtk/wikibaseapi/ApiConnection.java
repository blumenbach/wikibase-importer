...
public class ApiConnection {
	 ...
	 */
	public final static String URL_WIKIBASE_API = "http://w.b-ol.de/w/api.php";
	 ...
	 * @return {@link ApiConnection}
	 */
	public static ApiConnection getWikibaseApiConnection() {
		return new ApiConnection(ApiConnection.URL_WIKIBASE_API);
	}
